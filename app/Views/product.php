    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <table id="table" data-toolbar="#toolbar" data-search="true" data-show-refresh="true" data-show-columns="false" data-minimum-count-columns="2" data-show-pagination-switch="false" data-detail-view="false" data-detail-formatter="detailFormatter" data-pagination="true" data-page-list="[10, 25, 50, 100, all]" data-click-to-select="false" data-id-field="id" data-height="auto" data-url="<?= base_url('product/read')  ?>" data-side-pagination="server" data-response-handler="responseHandler" data-sort-name="id" data-sort-order="desc"></table>
        ...
        $(".action-edit").on('click', function() {
            ...
            $.post(base_url + `/product/edit`, {
                ...
                .done(function(data) {
                    ...
                    <input value="${data.response.product_code}" name="product_code" type="text" class="form-control">
                    </div>
                    ...
                    <div class="mb-3">
                    <label class="form-label text-capitalize">Currency</label>
                    <input value="${data.response.currency}" name="currency" type="text" class="form-control">
                    </div>

                    <div class="mb-3">
                    <label class="form-label text-capitalize">Discount</label>
                    <input value="${data.response.discount}" name="discount" type="number" class="form-control">
                    </div>

                    <div class="mb-3">
                    <label class="form-label text-capitalize">Dimension</label>
                    <input value="${data.response.dimension}" name="dimension" type="text" class="form-control">
                    </div>

                    <div class="mb-3">
                    <label class="form-label text-capitalize">Unit</label>
                    <input value="${data.response.unit}" name="unit" type="text" class="form-control">
                    </div>
