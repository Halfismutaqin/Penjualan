                    ...
                    <div class="col-12">
                      ...
                      <table id="example" class="table table-bordered table-striped table-hover" style="width: 100%;">
                        ...
                        <tbody class="table-content">
                          <?php $i = 1;
                          foreach ($pendingListMasterItem as $row) : 
                            ...
                            <tr>
                              ...
                              <td style="text-align: center; vertical-align: middle;"><a href="<?php echo $session_profile['session_address']; ?>pending_mi_detail/<?= $row['r_miID']; ?>" class="btn btn-primary">Detail</a></td>
                            </tr>
                          <?php endforeach ?>
                        </tbody>
                      </table>
