                  ...
                  <div class="col-12">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                      <li class="nav-item ml-auto ml-0" role="presentation">
                        <button class="nav-link active" id="active-tab" data-bs-toggle="tab" data-bs-target="#active" type="button" role="tab" aria-controls="closed" aria-selected="false">ALL DATA MASTER ITEM</button>
                      </li>
                    ...
                    <div class="tab-content" id="myTabContent">
                      <!-- TAB ACTIVE -->
                      <div class="tab-pane fade show active" id="active" role="tabpanel" aria-labelledby="closed-tab">
                        <br>
                        <!-- Table User List -->
                        <div class="table-responsive">
                          <table id="tableActive" class="table table-bordered table-striped table-hover table-responsive" style="width:100%">
                            <thead>
                              <tr>
                            ...
                            <tbody class="table-content">
                              <?php $i = 1;
                              foreach ($listManageMasterItem_all as $row) {
