...
<div class="content-wrapper">
  ...
  <form action="#" class="needs-validation" novalidate method="post" enctype="multipart/form-data" id="newmasterItem_page">
        ...
        <div class="card">
          ...
          <div class="card-header">
            <div class="row">
              ...
              <!-- BACK BUTTON -->
              <div class="col-lg-2 col-md-2 col-sm-12" style="margin: auto;">
                <a href="<?php echo $session_profile['session_address']; ?>rejected_reqMasterItem" class="btn btn-primary" style="width: 100%;"><i class="fa-solid fa-square-caret-left"></i> Back </a>
              </div>
              <!--/BACK BUTTON -->
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                      <div class="form-group">
                        ...
                        <input class="form-control" name="price" id="price" value="<?= $array['price'] ?>" required readonly>
                      </div>
                    </div>
                    <!-- Price -->
