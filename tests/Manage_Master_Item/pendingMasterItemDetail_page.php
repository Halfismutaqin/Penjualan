...
<div class="content-wrapper">
  ...
  <!-- Site Wrapper -->
  <form action="<?php echo $session_profile['session_address']; ?>reviewReqMI/<?= $miDetail->r_miID; ?>" class="needs-validation" novalidate method="post" enctype="multipart/form-data" id="newMasterItem_page">
        ...
        <div class="card">
          ...
          <div class="card-header">
            <div class="row">
              ...
              <!-- BACK BUTTON -->
              <div class="col-lg-2 col-md-2 col-sm-12" style="margin: auto;">
                <a href="<?php echo $session_profile['session_address']; ?>pending_reqMasterItem" class="btn btn-primary" style="width: 100%;"><i class="fa-solid fa-square-caret-left"></i> Back </a>
              </div>
              <!--/BACK BUTTON -->
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12">
                      <div class="form-group">
                        ...
                        <div class="input-group has-validation">
                          <input type="text" class="form-control" name="itemDesc" id="itemDesc"  value="<?= $data['itemDesc'] ?>" required readonly>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="new_itemDesc" id="new_itemDesc" placeholder="Insert New Master Item Description" value="">
                      </div>
                    </div>
                    <!-- New Item Desc -->
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-12">
                      <div class="form-group">
                        ...
                        <input class="form-control" name="price" id="price" value="<?= $data['price'] ?>" hidden required>
                      </div>
                    </div>
                    <!-- Price -->
                    ...
                    ?>
                      ...
                      <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="form-group">
                          ...
                          <div class="input-group has-validation">
                            <input type="text" class="form-control" name="specialCode" id="specialCode" style="text-transform: uppercase;" value="<?= $data['noCatalog_Sop_Code'] ?>" required>
                          </div>
                  ...
                  <div class="row">
                    ...
                    ?>
                      ...
                      <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="form-group">
                          ...
                          <div class="input-group has-validation">
                            <input type="text" class="form-control" name="manufacturer" id="manufacturer" style="text-transform: uppercase;" value="<?= $data['manufacturer'] ?>">
                          </div>
                        </div>
                      </div>
                      <!-- Manufacturer -->
                      ...
                      <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="form-group">
                          ...
                          <div class="input-group has-validation">
                            <input type="text" class="form-control" name="machineName" id="machineName" style="text-transform: uppercase;" value="<?= $data['machineName'] ?>">
                          </div>
                        </div>
                      </div>
                      <!-- Machine Name -->
                      ...
                      <div class="col-lg-4 col-md-6 col-sm-12">
                        <div class="form-group">
                          ...
                          <div class="input-group has-validation">
                            <input type="text" class="form-control" name="partNumber" id="partNumber" style="text-transform: uppercase;" value="<?= $data['partNumber'] ?>">
                          </div>
                        </div>
                      </div>
                      <!-- Part Number -->
                    <?php
                    } elseif (($data['type']) == "EXPENSE / ASSETS") {
                      $lock = "readonly";
                    } else {
                      $lock = "";
                    }
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12">
                      <div class="form-group">
                        ...
                        <div class="input-group has-validation">
                          <input type="number" class="form-control" <?= $lock; ?> name="stockMin" id="stockMin" style="text-transform: uppercase;" value="<?= $data['stockMin'] ?>">
                        </div>
                      </div>
                    </div>
                    <!-- Stock Minimum -->
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12">
                      <div class="form-group">
                        ...
                        <div class="input-group has-validation">
                          <input type="number" class="form-control" <?= $lock; ?> name="stockMax" id="stockMax" style="text-transform: uppercase;" value="<?= $data['stockMax'] ?>">
                        </div>
                      </div>
                    </div>
                    <!-- Stock Maximum -->
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12">
                      <div class="form-group">
                        ...
                        <div class="input-group has-validation">
                          <input type="number" class="form-control" name="leadTime" id="leadTime" style="text-transform: uppercase;" value="<?= $data['leadTime'] ?>">
                        </div>
                      </div>
                    </div>
                    <!-- Lead Time -->
                      ...
                      <div class="form-group">
                        ...
                        <div class="input-group has-validation">
                          <select id="action_mi" name="action_mi" class="form-control" style="text-transform: uppercase;" data-url="<?php echo $session_profile['session_address']; ?>ComboBox/get_masterCode">
                            <option value="NEW MASTER ITEM">New Master Item</option>
                            <option value="EXISTING DATA">Existing Data</option>
                            <option value="REJECT" class="text-danger"><strong>Reject Request</strong></option>
                          </select>
                        </div>
                      </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12">
                      <div class="form-group">
                        ...
                        <div class="input-group">
                          <input class="form-control" name="miNumber" id="miNumber" style="text-transform: uppercase;" placeholder="INPUT MASTER ITEM">
                      ...
                      <div class="form-group">
                        ...
                        <div class="input-group">
                          ...
                          <input id="masterCode" class="form-control" name="masterCode" style="text-transform: uppercase;" placeholder="INPUT MASTER CODE">
                          <div class="input-group-append">
...
<div id="modalHistorymi" class="modal">
  <div class="modal-dialog modal-xl" style="font-size: 80%;">
    <!-- Modal content -->
    <div class="modal-content">
      <div class="modal-header">
